...
import { HambergerMenu, Note, DirectNotification, Setting2, LogoutCurve, People, Buildings2, Calendar, Messages2, Category, Money2, Notification, Building4 } from 'iconsax-react';
